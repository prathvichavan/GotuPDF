 ...
 * POST /api/pdf-engine/validate
 * 
 * Validates PDF quality after editing
 */
  ...
  try {
    ...
    if (!response.ok) {
      ...
      return NextResponse.json(
        { success: false, error: error.detail || "Validation failed" },
    ...
    console.error("PDF validation proxy error:", error);
